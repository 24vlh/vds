# VDS Identity Component Audit

Last updated: `2026-05-24`

Source item: `VDS-2210`

This file records the identity component audit for the component modernization wave. It is a planning artifact only: no CSS, raw docs, generated docs metadata, generated `dist`, package metadata, workflows, selector inventory, consumer reports, npm tags, or version fields change here.

## Policy Summary

- `@24vlh/vds/src/identity.css` is the source truth for current identity CSS behavior.
- `@24vlh/vds/doc-raw/vds-identity.doc.html` and `@24vlh/agents/docs_vds/components/vds-identity.json` are docs/index evidence.
- Identity CSS provides visual inline SVG logo architecture, mark/wordmark styling, tokenized sizing, clearspace, color modes, and static asset guidance.
- Identity CSS is a standalone top-level package surface, not imported by `@24vlh/vds/src/core.css` or `@24vlh/vds/src/index.css`.
- Consumer/application code owns logo placement semantics, accessible names, decorative treatment, image `alt`, linking behavior, static asset selection, and contrast validation in context.
...
- No selector rewrite, docs rewrite, behavior implementation, generated index refresh, selector inventory update, logo asset regeneration, or generated output refresh happens in `VDS-2210`.
...
## Static Asset and Package Evidence
